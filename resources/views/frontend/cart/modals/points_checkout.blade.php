    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body fs-5">
                <p>Your total cart value : <strong class="text-danger"> <span id="m_final_total">
                            ₱
                            {{ isset(session()->get('voucher')['discount']) ? cartTotal() - session()->get('voucher')['discount'] : cartTotal() }}
                        </span></strong></p>
                <p>You have <strong class="text-danger">₱{{ Auth::user()->points->point_balance ?? 0 }}</strong> points
                    available.</p>
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" id="confirmPayWithPoints" data-name="point">Confirm
                    Payment</a>
            </div>
        </div>
    </div>
