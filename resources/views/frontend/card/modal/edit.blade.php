<div class="modal fade" id="cardEditModal" tabindex="-1" aria-labelledby="cardEditModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
          <div class="modal-body">
              <div class="text-center mb-4">
                  <h2 class="card-modal-title display-5" id="cardEditModalTitle">Card Edit</h2>
                  <hr>
              </div>

              <img src="{{ asset('frontend/images/card_5brand.png') }}" class="mb-4" alt="Card Image">
