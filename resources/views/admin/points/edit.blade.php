...
@section('content')
    <section class="section me-3">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('admin.point.update', $point->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="purchase_amount" id="purchase_amount"
                            value="{{ old('purchase_amount', $point->purchase_amount) }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="bonus_points" id="bonus_points"
                            value="{{ old('bonus_points', $point->bonus_points) }}">
                        @error('bonus_points')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
